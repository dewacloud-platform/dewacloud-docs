...
<img src="https://assets.dewacloud.com/dewacloud-docs/windows-&-.net/managing-server-roles-&-features/01-windows-server-manager.png" alt="Windows server manager" width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/windows-&-.net/managing-server-roles-&-features/02-windows-add-roles.png" alt="Windows add roles" width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/windows-&-.net/managing-server-roles-&-features/03-windows-server-select.png" alt="Windows server select" width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/windows-&-.net/managing-server-roles-&-features/04-windows-server-roles.png" alt="Windows server roles" width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/windows-&-.net/managing-server-roles-&-features/05-windows-add-features.png" alt="Windows add features" width="60%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/windows-&-.net/managing-server-roles-&-features/06-windows-role-services.png" alt="Windows role services" width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/windows-&-.net/managing-server-roles-&-features/07-windows-install-roles-and-features.png" alt="Windows install roles and features" width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/windows-&-.net/managing-server-roles-&-features/08-windows-roles-and-features-installed.png" alt="Windows roles and features installed" width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/windows-&-.net/managing-server-roles-&-features/09-windows-remove-roles-and-features.png" alt="Windows remove roles and features" width="100%"/>
