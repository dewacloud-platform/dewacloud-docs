...
<img src="https://assets.dewacloud.com/dewacloud-docs/databases/databases-hosting/db-hosting-overview/db-hosting-overview-2.png" alt="create environment with database" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/databases/databases-hosting/db-hosting-overview/db-hosting-overview-4.png" alt="database password reset" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/databases/databases-hosting/db-hosting-overview/db-hosting-overview-5.png" alt="database node ID" max-width="100%"/>
