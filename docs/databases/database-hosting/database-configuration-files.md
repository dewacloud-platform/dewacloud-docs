...
<img src="https://assets.dewacloud.com/dewacloud-docs/databases/databases-hosting/database-configuration-files/db-configuration-files-1.png" alt="database php.ini" width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/databases/databases-hosting/database-configuration-files/db-configuration-files-2.png" alt="MySQL my.cnf" width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/databases/databases-hosting/database-configuration-files/db-configuration-files-3.png" alt="database cron config" width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/databases/databases-hosting/database-configuration-files/db-configuration-files-4.png" alt="database scripts folder" width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/databases/databases-hosting/database-configuration-files/db-configuration-files-5.png" alt="database backup folder" width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/databases/databases-hosting/database-configuration-files/db-configuration-files-6.png" alt="database keys folder" width="100%"/>

## CONF.D {#confd}

Folder **/etc/httpd/conf.d** biasanya digunakan untuk menyimpan dan mengelola sub-konfigurasi.

<img src="https://assets.dewacloud.com/dewacloud-docs/databases/databases-hosting/database-configuration-files/db-configuration-files-7.png" alt="database conf.d folder" width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/databases/databases-hosting/database-configuration-files/db-configuration-files-8.png" alt="postgresql.conf configuration file" width="100%"/>
