...
<img src="https://assets.dewacloud.com/dewacloud-docs/databases/mongodb/connection-to-applications/php-connection/php-connection-1.png" alt="create mongodb environment" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/databases/mongodb/connection-to-applications/php-connection/php-connection-2.png" alt="email mongo credentials" max-width="100%"/>

2\. Di sini, klik pada tautan _Access URL_ atau beralih ke dashboard dan **Open in browser** node _MongoDB_ Anda.

<img src="https://assets.dewacloud.com/dewacloud-docs/databases/mongodb/connection-to-applications/php-connection/php-connection-3.png" alt="mongo admin panel log in" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/databases/mongodb/connection-to-applications/php-connection/php-connection-4.png" alt="create database" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/databases/mongodb/connection-to-applications/php-connection/php-connection-5.png" alt="execute command" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/databases/mongodb/connection-to-applications/php-connection/php-connection-6.png" alt="environment node config" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/databases/mongodb/connection-to-applications/php-connection/php-connection-7.png" alt="phpini mongo driver" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/databases/mongodb/connection-to-applications/php-connection/php-connection-8.png" alt="restart application server" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/databases/mongodb/connection-to-applications/php-connection/php-connection-9.png" alt="application deployed" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/databases/mongodb/connection-to-applications/php-connection/php-connection-10.png" alt="good connection" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/databases/mongodb/connection-to-applications/php-connection/php-connection-11.png" alt="check phptest collection" max-width="100%"/>
