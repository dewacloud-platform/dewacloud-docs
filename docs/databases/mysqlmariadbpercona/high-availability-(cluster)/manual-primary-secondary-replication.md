...
Anda dapat mengatur cluster DB dengan dua cara:

  * [otomatis](<https://docs.dewacloud.com/docs/#one-click-installation>) (melalui one-click widget)
  * [manual](<https://docs.dewacloud.com/docs/#manual-installation>) (mengikuti instruksi langkah demi langkah)

## One-Click Installation{#one-click-installation}

Anda dapat mendapatkan cluster database **MySQL** atau **MariaDB** dengan jenis replikasi yang diperlukan (termasuk _master-slave_) yang dapat dijalankan dalam hitungan menit menggunakan widget instalasi sekali klik:

Prosesnya sederhana - cukup masukkan email Anda dan konfirmasi melalui notifikasi yang sesuai. Baca artikel **[MariaDB/MySQL Auto-Clustering](<https://docs.dewacloud.com/company/blog/mysql-mariadb-database-auto-clustering-cloud-hosting/>)** untuk informasi lebih lanjut tentang paket yang diinstal dan opsi kustomisasi yang tersedia.
