...
2. Lakukan koneksi ke container melalui [SSH Gate](https://docs.dewacloud.com/docs/ssh-gate/) dan operasikan package Anda secara manual dengan command berikut:
...
Anda dapat menggunakan daftar command berikut untuk bekerja dengan Yarn, saat terhubung melalui [SSH](https://docs.dewacloud.com/docs/ssh-gate/):
