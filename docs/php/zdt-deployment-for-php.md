...
![php zero downtime deploy scheme](#)
...
**Catatan:** Ketersediaan fungsionalitas ini bergantung pada pengaturan penyedia hosting Anda.
...
![zero downtime deployment graph](#)
...
![VCS zero downtime deployment graph](#)
