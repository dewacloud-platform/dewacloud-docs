...
<img src="https://assets.dewacloud.com/dewacloud-docs/php/php-app-servers/apache-php/add-apache-modules/01-create-php-environment.png" alt="create php environment" max-width="100%"/>

4\. Dalam beberapa detik, environment Anda akan muncul di dashboard platform.

<img src="https://assets.dewacloud.com/dewacloud-docs/php/php-app-servers/apache-php/add-apache-modules/02-environment-created.png" alt="environment created" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/php/php-app-servers/apache-php/add-apache-modules/03-environment-node-config.png" alt="environment node config" max-width="100%"/>

2\. Unggah file _**mod_pony.so**_ ke folder **/usr/lib64/php/modules**.

<img src="https://assets.dewacloud.com/dewacloud-docs/php/php-app-servers/apache-php/add-apache-modules/04-upload-module.png" alt="upload module" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/php/php-app-servers/apache-php/add-apache-modules/05-httpd-load-module.png" alt="httpd load module" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/php/php-app-servers/apache-php/add-apache-modules/06-apache-module-settings.png" alt="apache module settings" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/php/php-app-servers/apache-php/add-apache-modules/07-run-application.png" alt="run application" max-width="100%"/>
