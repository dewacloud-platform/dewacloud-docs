...
:::note
Stack ini (sejak rilis 1.16.1) & LLSMP siap untuk [HTTP/3](https://docs.dewacloud.com/docs/http3/) dengan dukungan fitur yang diaktifkan secara default. Namun, diperlukan alamat [IP publik](https://docs.dewacloud.com/docs/public-ip/) untuk melewati Shared Load Balancer dan bekerja langsung dengan server melalui HTTP/3.
:::
...
<img src="https://assets.dewacloud.com/dewacloud-docs/php/php-app-servers/lemp-and-lllsmp/01-lemp-llsmp-containers-structure.png" alt="LEMP LLSMP containers structure" width="70%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/php/php-app-servers/lemp-and-lllsmp/02-create-new-environment-button.png" alt="create new environment button" width="70%"/>
...
:::note
LLSMP memiliki variabel tambahan (misalnya WAF, WP_PROTECT, WP_PROTECT_LIMIT) yang spesifik untuk stack [LiteSpeed](https://docs.dewacloud.com/docs/litespeed-web-server/), yang dijelaskan dalam dokumen khusus.
:::
