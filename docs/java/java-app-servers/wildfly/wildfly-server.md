...
<img src="https://assets.dewacloud.com/dewacloud-docs/java/java-app-servers/wildfly/wildfly-server/wildfly-server-3.png" alt="WildFly server topology wizard" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/java/java-app-servers/wildfly/wildfly-server/wildfly-server-4.png" alt="WildFly open in browser" max-width="100%"/>

4\. Halaman standar WildFly menyuguhkan beberapa tautan berguna untuk membantu Anda memulai.

<img src="https://assets.dewacloud.com/dewacloud-docs/java/java-app-servers/wildfly/wildfly-server/wildfly-server-5.png" alt="WildFly home page" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/java/java-app-servers/wildfly/wildfly-server/wildfly-server-6.png" alt="WildFly standalone config variable" max-width="100%"/>
