...
<img src="https://assets.dewacloud.com/dewacloud-docs/java/java-app-servers/glassfish/glassfish-server/glassfish-server-1.png" alt="use java" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/java/java-app-servers/glassfish/glassfish-server/glassfish-server-2.png" alt="glassfish 02serv run" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/java/java-app-servers/glassfish/glassfish-server/glassfish-server-3.png" alt="glassfish 03dash" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/java/java-app-servers/glassfish/glassfish-server/glassfish-server-4.png" alt="gfcluster" max-width="100%"/>
...
```
<img src="https://assets.dewacloud.com/dewacloud-docs/java/java-app-servers/glassfish/glassfish-server/glassfish-server-5.png" alt="glassfish public ip" max-width="100%"/>
