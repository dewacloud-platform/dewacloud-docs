...
<img src="https://assets.dewacloud.com/dewacloud-docs/application_settings/scaling-and-clustering/data-synchronization/04-environment-wizard.png" alt="environment wizard" width="100%"/>

4\. Unggah proyek Anda menggunakan **Deployment Manager**.

<img src="https://assets.dewacloud.com/dewacloud-docs/application_settings/scaling-and-clustering/data-synchronization/01-pay-per-use-pricing.png" alt="upload application archive" width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/application_settings/scaling-and-clustering/data-synchronization/02-cloudlet-resources.png" alt="deploy application" width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/application_settings/scaling-and-clustering/data-synchronization/03-automatic-vertical-scaling.png" alt="data synchronization during scaling" width="100%"/>
