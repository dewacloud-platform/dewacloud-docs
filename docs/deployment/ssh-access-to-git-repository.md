...
<img src="https://assets.dewacloud.com/dewacloud-docs/deployment/ssh-access-to-git-repository/01-git-ssh-access.png" alt="GIT SSH access" max-width="100%"/>
...
:::warning
 Kunci Anda tidak boleh mengandung perlindungan kata sandi (passphrase) agar dapat digunakan untuk menjalin koneksi antara platform dan akun GIT. 
:::
...
<img src="https://assets.dewacloud.com/dewacloud-docs/deployment/ssh-access-to-git-repository/02-account-settings.png" alt="account settings" max-width="100%"/>

2. Di dalam tab **Pengaturan Pengguna** yang terbuka, beralih ke opsi **SSH Keys > Private Keys** dan klik tombol **Add Private Key**.

<img src="https://assets.dewacloud.com/dewacloud-docs/deployment/ssh-access-to-git-repository/03-ssh-keys-settings.png" alt="SSH keys settings" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/deployment/ssh-access-to-git-repository/04-add-private-key.png" alt="add private SSH key" max-width="100%"/>

:::warning
 Jika Anda menerima kesalahan saat menambahkan kunci, pastikan kunci tersebut tidak dilindungi dengan passphrase. Jika iya, hilangkan perlindungan tersebut dan coba lagi.
 :::

4. Hasilnya, kunci privat baru Anda akan muncul di tab yang sesuai dalam sesaat.

<img src="https://assets.dewacloud.com/dewacloud-docs/deployment/ssh-access-to-git-repository/05-private-ssh-key-added.png" alt="private SSH key added" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/deployment/ssh-access-to-git-repository/06-github-ssh-keys-settings.png" alt="GitHub SSH keys settings" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/deployment/ssh-access-to-git-repository/07-github-add-public-key.png" alt="GitHub add public key" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/deployment/ssh-access-to-git-repository/08-github-confirm-key-addition.png" alt="GitHub confirm key addition" max-width="100%"/>

4. Periksa kunci yang baru ditambahkan telah muncul di tab **SSH keys** yang sama.

<img src="https://assets.dewacloud.com/dewacloud-docs/deployment/ssh-access-to-git-repository/09-github-ssh-key-added.png" alt="GitHub SSH key added" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/deployment/ssh-access-to-git-repository/10-github-copy-git-link.png" alt="GitHub copy GIT link" max-width="100%"/>

### GitLab{#gitlab}

1. Masuk ke akun GitLab Anda. Akses **Settings** akun (di pojok kanan atas) dan masuk ke tab **SSH Keys** di menu sebelah kiri.

<img src="https://assets.dewacloud.com/dewacloud-docs/deployment/ssh-access-to-git-repository/11-gitlab-ssh-keys-settings.png" alt="GitLab SSH keys settings" max-width="100%"/>
...
:::note
 Tanggal kedaluwarsa bersifat informatif dan tidak mencegah Anda menggunakan kunci tersebut. Misalnya, dapat digunakan oleh administrator untuk menjaga kunci tetap berotasi. 
:::

<img src="https://assets.dewacloud.com/dewacloud-docs/deployment/ssh-access-to-git-repository/12-gitlab-add-public-ssh-key.png" alt="GitLab add public SSH key" max-width="100%"/>

Klik tombol **Add key**.

3. Kunci Anda seharusnya muncul dalam daftar **Your SSH keys** di bawahnya.

<img src="https://assets.dewacloud.com/dewacloud-docs/deployment/ssh-access-to-git-repository/13-gitlab-ssh-key-added.png" alt="GitLab SSH key added" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/deployment/ssh-access-to-git-repository/14-gitlab-copy-git-link.png" alt="GitLab copy GIT link" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/deployment/ssh-access-to-git-repository/15-bitbucket-manage-account.png" alt="Bitbucket manage account" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/deployment/ssh-access-to-git-repository/16-bitbucket-ssh-keys-settings.png" alt="Bitbucket SSH keys settings" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/deployment/ssh-access-to-git-repository/17-bitbucket-add-ssh-key.png" alt="Bitbucket add SSH key" max-width="100%"/>

4. Periksa kunci yang baru ditambahkan telah muncul di tab **SSH keys** yang sama.

<img src="https://assets.dewacloud.com/dewacloud-docs/deployment/ssh-access-to-git-repository/18-bitbucket-ssh-key-added.png" alt="Bitbucket SSH key added" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/deployment/ssh-access-to-git-repository/19-bitbucket-copy-git-link.png" alt="Bitbucket copy GIT link" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/deployment/ssh-access-to-git-repository/20-add-repository-with-ssh-key-authentication.png" alt="add repository with SSH key authentication" max-width="100%"/>
...
:::note
 Untuk environment berbasis Java, Anda perlu memilih node build secara tambahan. 
:::
...
<img src="https://assets.dewacloud.com/dewacloud-docs/deployment/ssh-access-to-git-repository/22-deploy-git-project.png" alt="deploy GIT project" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/deployment/ssh-access-to-git-repository/23-example-application-files.png" alt="example application files" max-width="100%"/>

4. Akhirnya, Anda dapat mengklik **Open in Browser** untuk environment Anda dan pastikan aplikasi Anda berjalan.

<img src="https://assets.dewacloud.com/dewacloud-docs/deployment/ssh-access-to-git-repository/24-open-in-browser-button.png" alt="open in browser button" max-width="100%"/>

<img src="https://assets.dewacloud.com/dewacloud-docs/deployment/ssh-access-to-git-repository/25-example-hello-world-application.png" alt="example hello world application" max-width="100%"/>
