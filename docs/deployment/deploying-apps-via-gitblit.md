...
3\. Dalam frame _**Add project**_ yang muncul, pilih tab **Git** dan isi field yang diperlukan:
   ...
   * ketik _**Context**_ yang Anda ingin mendeply proyek Anda ![gitblit 15add project 2](#)
