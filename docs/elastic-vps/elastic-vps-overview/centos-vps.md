...
Untuk dengan mudah mengatur **CentOS [Elastic VPS](https://docs.dewacloud.com/vps/)** Anda sendiri di dalam platform, masuk ke dashboard Dewacloud dan akses wizard topologi environment.
