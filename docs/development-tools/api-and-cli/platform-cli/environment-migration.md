...
<img src="https://assets.dewacloud.com/dewacloud-docs/development-tools/api-and-cli/platform-cli/environment-migration/environment-migration-1.png" alt="CLI get regions info" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/development-tools/api-and-cli/platform-cli/environment-migration/environment-migration-2.png" alt="CLI check migration possibility" max-width="100%"/>
...
<img src="https://assets.dewacloud.com/dewacloud-docs/development-tools/api-and-cli/platform-cli/environment-migration/environment-migration-3.png" alt="CLI migrate environment" max-width="100%"/>
